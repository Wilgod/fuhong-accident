            ...
            <div className="container-fluid px-4 pt-4">
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col-12 col-md-4">
                            ...
                            <select className={`custom-select ${(error && error['ServiceUnit']) ? "is-invalid" : ""}`} value={patientServiceUnit} onChange={(event) => { setPatientServiceUnit(event.target.value) }}
                                disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)}
                            >
                                <option value={""} ></option>
                ...
                <section className="mb-5">
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col-12 col-md-4">
                            <input type="text" className={`form-control ${(error && error['ServiceUserNameTC']) ? "is-invalid" : ""}`} name="serviceUserNameTC" value={form.serviceUserNameTC} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                        </div>
                        {/* 服務使用者姓名 (英文)*/}
                        <label className={`col-12 col-md-2 col-form-label ${styles.fieldTitle} pt-xl-0`}>姓名 (英文)</label>
                        <div className="col-12 col-md-4">
                            <input type="text" className={`form-control ${(error && error['ServiceUserNameEN']) ? "is-invalid" : ""}`} name="serviceUserNameEN" value={form.serviceUserNameEN} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                        </div>
                    </div>
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col-12 col-md-4">
                            <input type="number" className={`form-control ${(error && error['ServiceUserAge']) ? "is-invalid" : ""}`} name="ServiceUserAge" value={form.serviceUserAge} onChange={(evnet) => setForm({ ...form, serviceUserAge: +evnet.target.value })} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                        </div>
                        {/* 性別*/}
                        ...
                        <div className={`col-12 col-md-4 d-flex align-items-center ${(error && error['ServiceUserGender']) ? styles.divInvalid : ""}`}>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" id="gender-male" onClick={() => setForm({ ...form, serviceUserGender: "male" })} checked={form.serviceUserGender === "male"} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                <label className={`form-check-label ${styles.labelColor}`} htmlFor="gender-male">男</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" id="gender-female" onClick={() => setForm({ ...form, serviceUserGender: "female" })} checked={form.serviceUserGender === "female"} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col-12 col-md-4">
                            <select className={`form-control ${(error && error['ServiceUserIdentity']) ? "is-invalid" : ""}`} name="serviceUserIdentity" value={form.serviceUserIdentity} onChange={selectionHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)}>
                            ...
                            </select>
                            {
                                ...
                                <div className="mt-2">
                                    <input type="text" className={`form-control ${(error && error['ServiceUserIdentityOther']) ? "is-invalid" : ""}`} placeholder="請註明" name="serviceUserIdentityOther" value={form.serviceUserIdentityOther} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                </div>
                            }
                        </div>
                        {/* 意外發生日期*/}
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col">
                            <AutosizeTextarea className="form-control" name="accidentLocation" value={form.accidentLocation} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-5">
                    ...
                    <div>
                        <div className="form-row mb-4">
                            ...
                            <div className="col">
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envSlipperyGround" id="ENV-SLIPPERY-GROUND" checked={form.envSlipperyGround === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-SLIPPERY-GROUND">地面濕滑</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envUnevenGround" id="ENV-UNEVEN-GROUND" value="ENV_UNEVEN_GROUND" checked={form.envUnevenGround === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-UNEVEN-GROUND">地面不平</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envObstacleItems" id="ENV-OBSTACLE-ITEMS" value="ENV_OBSTACLE_ITEMS" checked={form.envObstacleItems === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-OBSTACLE-ITEMS">障礙物品</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envInsufficientLight" id="ENV-INSUFFICIENT-LIGHT" value="ENV_INSUFFICIENT_LIGHT" checked={form.envInsufficientLight === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-INSUFFICIENT-LIGHT">光線不足</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envNotEnoughSpace" id="ENV-NOT-ENOUGH-SPACE" value="ENV_NOT_ENOUGH_SPACE" checked={form.envNotEnoughSpace === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-NOT-ENOUGH-SPACE">空間不足</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envAcousticStimulation" id="ENV-ACOUSTIC-STIMULATION" value="ENV_ACOUSTIC_STIMULATION" checked={form.envAcousticStimulation === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-ACOUSTIC-STIMULATION">聲響刺激</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envCollidedByOthers" id="ENV-COLLIDED-BY-OTHERS" value="ENV_COLLIDED_BY_OTHERS" checked={form.envCollidedByOthers === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-COLLIDED-BY-OTHERS">被別人碰撞</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envHurtByOthers" id="ENV-HURT-BY-OTHERS" value="ENV_HURT_BY_OTHERS" checked={form.envHurtByOthers === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-HURT-BY-OTHERS">被別人傷害</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" name="envImproperEquip" id="ENV-IMPROPER-USE-OF-ASSISTIVE-EQUIPMENT" checked={form.envImproperEquip === true} value="ENV_IMPROPER_USE_OF_ASSISTIVE_EQUIPMENT" onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                ...
                                <div className="form-check">
                                    <input className="form-check-input" type="checkbox" name="envOther" id="ENV-OTHER" value="ENV_OTHER" checked={form.envOther === true} onClick={checkboxBoolHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="ENV-OTHER">其他</label>
                                </div>
                                {
                                    form.envOther &&
                                    <div className="">
                                        <AutosizeTextarea className={`form-control ${(error && error['EnvOtherDescription']) ? "is-invalid" : ""}`} placeholder="請註明" name={"envOtherDescription"} value={form.envOtherDescription} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    </div>
                                }
                            </div>
                        </div>
                        <div className="form-row mb-4">
                            ...
                            <div className="col">
                                <AutosizeTextarea className="form-control" name="otherFactor" value={form.otherFactor} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                            </div>
                        </div>
                    </div>
                    <div className="form-row mb-2">
                        ...
                        <div className="col">
                            <AutosizeTextarea className="form-control" name="accidentDetail" value={form.accidentDetail} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                        </div>
                    </div>
                    ...
                    <div className="form-row mb-4">
                        ...
                        <div className={`col ${(error && error['Witness']) ? styles.divInvalid : ""}`}>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="witness" id="witness-true" value="witness-true" onClick={() => setForm({ ...form, witness: true })} checked={form.witness === true} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                <label className={`form-check-label ${styles.labelColor}`} htmlFor="witness-true">有</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="witness" id="witness-false" value="witness-false" onClick={() => setForm({ ...form, witness: false })} checked={form.witness === false} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                            ...
                            </div>
                            {
                                ...
                                <>
                                    <div>
                                        ...
                                        <input type="text" className={`form-control ${(error && error['WitnessName']) ? "is-invalid" : ""}`} name="witnessName" value={form.witnessName} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    </div>
                                    <div>
                                        <label className="form-label">聯絡電話</label>
                                        <input type="text" className={`form-control ${(error && error['WitnessPhone']) ? "is-invalid" : ""}`} name="witnessPhone" value={form.witnessPhone} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    </div>
                                </>
                            }
                        </div>
                    ...
                    <div className="form-row mb-4">
                        ...
                        <div className={`col ${(error && error['PhotoRecord']) ? "is-invalid" : ""}`}>
                            ...
                            <div className="pl-2">
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" name="photoRecord" id="photo-true" value="PHOTO_TRUE" onClick={() => setForm({ ...form, photoRecord: true })} checked={form.photoRecord === true} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                ...
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" name="photoRecord" id="photo-false" value="PHOTO_FALSE" onClick={() => setForm({ ...form, photoRecord: false })} checked={form.photoRecord === false} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                            ...
                            <div className={`pl-2 ${(error && error['CctvRecord']) ? "is-invalid" : ""}`}>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" name="cctv" id="cctv-true" value="CCTV_TRUE" onClick={() => setForm({ ...form, cctvRecord: true })} checked={form.cctvRecord === true} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    <label className={`form-check-label ${styles.labelColor}`} htmlFor="cctv-true">有 (註: 三個工作天內交總辦事處)</label>
                                </div>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" name="cctv" id="cctv-false" value="CCTV_FALSE" onClick={() => setForm({ ...form, cctvRecord: false })} checked={form.cctvRecord === false} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                ...
                <section className="mb-5">
                    ...
                    <div className="form-row mb-4">
                        ...
                        <div className={`col ${(error && error['MedicalArrangement']) ? styles.divInvalid : ""}`}>
                            ...
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="medicalArrangement" id="ARRANGEMENT_OUTPATIENT" value="ARRANGEMENT_OUTPATIENT" onClick={radioButtonHandler} checked={form.medicalArrangement === "ARRANGEMENT_OUTPATIENT"} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                <label className={`form-check-label ${styles.labelColor}`} htmlFor="ARRANGEMENT_OUTPATIENT">門診</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="medicalArrangement" id="ARRANGEMENT_EMERGENCY_DEPARTMENT" value="ARRANGEMENT_EMERGENCY_DEPARTMENT" onClick={radioButtonHandler} checked={form.medicalArrangement === "ARRANGEMENT_EMERGENCY_DEPARTMENT"} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                            ...
                            </div>
                            {
                                ...
                                <>
                                    <div className="">
                                        ...
                                        <input type="text" className={`form-control ${(error && error['MedicalArrangementHospital']) ? "is-invalid" : ""}`} value={form.medicalArrangementHospital} name="medicalArrangementHospital" onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    </div>
                                    <div className="">
                    ...
                    <div className="form-row mb-4">
                        ...
                        <div className={`col ${(error && error['Police']) ? styles.divInvalid : ""}`}>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="police" id="police-true" value="police-true" onClick={() => setForm({ ...form, police: true })} checked={form.police === true} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                <label className={`form-check-label ${styles.labelColor}`} htmlFor="police-true">有</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="police" id="police-false" value="police-false" onClick={() => setForm({ ...form, police: false })} checked={form.police === false} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                            ...
                            </div>
                            {
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" className={`form-control ${(error && error['PoliceStation']) ? "is-invalid" : ""}`} name="policeStation" value={form.policeStation} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    </div>
                                </>
                            }
                        </div>
                    ...
                    <div className="form-row mb-4">
                        ...
                        <div className={`col ${(error && error['FamilyContact']) ? styles.divInvalid : ""}`}>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="familyContact" id="family-true" value="family-true" onClick={() => setForm({ ...form, familyContact: true })} checked={form.familyContact === true} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                <label className={`form-check-label ${styles.labelColor}`} htmlFor="family-true">有</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="familyContact" id="family-false" value="family-false" onClick={() => setForm({ ...form, familyContact: false })} checked={form.familyContact === false} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                            ...
                            </div>
                            {
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" className={`form-control ${(error && error['FamilyRelationship']) ? "is-invalid" : ""}`} name="familyRelationship" value={form.familyRelationship} onChange={inputFieldHandler} disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitial(currentUserRole, formStatus) && !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                                    </div>
                                </>
                            }
                        </div>
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col">
                            <AutosizeTextarea className="form-control" value={smComment} onChange={(event) => setSmComment(event.target.value)}
                                disabled={!pendingSmApprove(CURRENT_USER.email, currentUserRole, formStatus, formStage, smInfo) && !formInitBySm(CURRENT_USER.email, spSmInfo ? spSmInfo.Email : "", formStatus)} />
                        </div>
                    </div>
                    {
                ...
                <section className="mb-4">
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col">
                            <AutosizeTextarea className="form-control" value={sdComment} onChange={(event) => setSdComment(event.target.value)} disabled={!pendingSptApproveForSD(CURRENT_USER.email, currentUserRole, formStatus, formStage, sptDate, sdInfo)} />
                        </div>
                    </div>
                ...
                <section className="mb-4">
                    ...
                    <div className="form-row mb-2">
                        ...
                        <div className="col">
                            <AutosizeTextarea className="form-control" value={sptComment} onChange={(event) => setSptComment(event.target.value)} disabled={!pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)} />
                        </div>
                    </div>
                        ...
                        <div className="col-12 col-md-4">
                            {
                                !pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail) ?
                                    ...
                                    <PeoplePicker
                                        ...
                                        disabled={!pendingSptApproveForSPT(CURRENT_USER.email, currentUserRole, formStatus, formStage, sPhysicalTherapyEmail)}
                                    />
                            }
                        </div>
