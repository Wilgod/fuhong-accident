   ...
   debugger
    const initial = async () => {
        ...
        if (searchFormTypesAll || searchCriteria.formTypes.indexOf("SUI") > -1) {
            ...
            if (key != null && key != '') {
                filterServiceUserAccidentData = serviceUserAccidentData.filter(item=> {return item.ServiceUserNameCN.toLocaleLowerCase() == key || item.ServiceUserNameEN.toLocaleLowerCase() == key  || 
                    item.ServiceUserAge.toLocaleLowerCase() == key || item.ServiceUserGender.toLocaleLowerCase() == key || item.CaseName.toLocaleLowerCase() == key || item.InsuranceCaseNo.toLocaleLowerCase() == key })
            }
        ...
        if (searchFormTypesAll || searchCriteria.formTypes.indexOf("PUI") > -1) {
            ...
            if (key != null && key != '') {
                filterOutsiderAccidentData = outsiderAccidentData.filter(item=> {return item.ServiceUserNameTC.toLocaleLowerCase() == key || item.ServiceUserNameEN.toLocaleLowerCase() == key  || 
                    item.ServiceUserAge.toLocaleLowerCase() == key || item.ServiceUserGender.toLocaleLowerCase() == key || item.CaseName.toLocaleLowerCase() == key || item.InsuranceCaseNo.toLocaleLowerCase() == key})
            }
        ...
        if (searchFormTypesAll || searchCriteria.formTypes.indexOf("SIH") > -1) {
            ...
            if (key != null && key != '') {
                filterSpecialIncidentReportLicense = specialIncidentReportLicense.filter(item=> {return item.ResponsibleName.toLocaleLowerCase() == key || item.HomesManagerName.toLocaleLowerCase() == key  || 
                    item.GuardianName.toLocaleLowerCase() == key || item.GuardianRelation.toLocaleLowerCase() == key || item.CaseName.toLocaleLowerCase() == key || item.InsuranceCaseNo.toLocaleLowerCase() == key})
            }
        ...
        if (searchFormTypesAll || searchCriteria.formTypes.indexOf("SID") > -1) {
            ...
            if (key != null && key != '') {
                filterSpecialIncidentReporAllowance = specialIncidentReportAllowance.filter(item=> {return item.IncidentLocation.toLocaleLowerCase() == key || item.GuardianDescription.toLocaleLowerCase() == key  || 
                    item.GuardianName.toLocaleLowerCase() == key || item.GuardianRelation.toLocaleLowerCase() == key || item.CaseName.toLocaleLowerCase() == key || item.InsuranceCaseNo.toLocaleLowerCase() == key})
            }
        ...
        if (searchFormTypesAll || searchCriteria.formTypes.indexOf("OIN") > -1) {
            ...
            if (key != null && key != '') {
                filterOtherIncidentData = otherIncidentData.filter(item=> {return item.IncidentLocation.toLocaleLowerCase() == key || item.GuardianDescription.toLocaleLowerCase() == key  || 
                    item.GuardianName.toLocaleLowerCase() == key || item.GuardianRelation.toLocaleLowerCase() == key || item.CaseName.toLocaleLowerCase() == key || item.InsuranceCaseNo.toLocaleLowerCase() == key})
            }
