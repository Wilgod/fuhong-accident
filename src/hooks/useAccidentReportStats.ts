import { getAccidentReportStats, getServiceUserStats } from "../api/FetchFuHongListStats";
import { Dispatch, SetStateAction, useEffect, useState } from 'react';


// Stats
export function useAccidentReportStats(permission): [any[], Date, Date, string[], Dispatch<SetStateAction<Date>>, Dispatch<SetStateAction<Date>>, Dispatch<SetStateAction<string[]>>] {
