...
function OutsiderAccidentEnv(props) {
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 byMonthFinancialLineChart9">
                            <div className="text-center mb-2" style={{ fontSize: 16 }}>
                                ...
                                <div className="">
                                外界人士意外 - 意外成因 - 環境因素 - 輔助器材使用不當 (如輪椅／便椅未上鎖) (每月總數)
                                </div>
                            </div>
                            <Chart
                                width={'100%'}
